...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('admin.penyewaan')}}">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Camera <span>| All</span></h5>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Penyewaan <span>| This Year</span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$order->harga}}</td>
                            <td>{{$order->ends}}</td>
                            <td><a href="{{route('admin.penyewaan')}}" class="badge bg-primary">Detail</a></td>
                        </tr>
                        @endforeach
